----------------------------------------------------------------
-- GAME DEF : Doom 1 (Modified by Mr. Chris)
----------------------------------------------------------------
--
--  Oblige Level Maker (C) 2006,2007 Andrew Apted
--  Modifications by Sam Trenholme and "Mr. Chris"
--
...
DMC_COMBOS =
{
  ...
  TECH_BASEA =
  {
    ...
    pic_wd = "COMPSTA1",    -- "COMP2" for Doom 1 !!
    pic_wd_h = 64,
...
-- Texture and flat combo is used in first big room of E1M4
  ...
  HELL_MARBLE =
  {
    ...
    scenery = { green_pillar=5, green_column=5, green_column_hrt=2, impaled_human=4, impaled_twitch=2, skull_pole=2, skull_kebab=3, dead_player=2, gibbed_player=2 },
...
HELL_MARBLE3 =
  ...
  HELL_HOT =
  {
    ...
    floor = "FLAT5_3",  -- was: FLAT5_7
    ceil  = "FLAT5_3",  -- was: FLOOR6_1
    vista_support = "FIREBLU2",

    lift = "SUPPORT3",
    lift_floor = "CEIL5_2",

    scenery = { red_torch=5, red_pillar=3, red_column=3, red_column_skl=1, impaled_human=4, impaled_twitch=2, skull_pole=2, skull_kebab=3, dead_player=2, gibbed_player=2 },
  ...
  HELL_VINE =
  {
    ...
    scenery = { green_torch=5, green_pillar=5, green_column=5, green_column_hrt=2, impaled_human=4, impaled_twitch=2, skull_pole=2, skull_kebab=3, dead_player=2, gibbed_player=2 },
  },
  ...
  HELL_WOOD =
  {
    ...
    ceil  = "FLAT5_2",  -- was: FLOOR6_1
    vista_support = "METAL",

    lift = "SUPPORT3",
    lift_floor = "CEIL5_2",

    scenery = { red_torch=5, blue_torch=5, green_torch=5, impaled_human=4, impaled_twitch=2, skull_pole=2, skull_kebab=3, dead_player=2, gibbed_player=2 },
  ...
  HELL_WOOD2 =
  {
    ...
    floor = "FLAT5_2",  -- was: FLAT5_7
    ceil  = "CEIL1_1",  -- was: FLOOR6_1
  ...
  HELL_ICKY =
  {
    ...
    floor = "FLOOR0_3",  -- was: FLAT5_7
    ceil  = "FLAT5_4",  -- was: FLOOR6_1
  ...
  HELL_SKIN =
  {
    ...
    scenery = { red_torch=5, green_torch=5, blue_torch=5, impaled_human=3, impaled_twitch=2, skull_pole=2, skull_kebab=2, dead_player=2, gibbed_player=1, gibs=1, skull_cairn=2, evil_eye=2 },
...
--  void = "STONE3",
    ...
    scenery = { blue_torch=5, blue_torch_sm=3, green_torch=5, green_torch_sm=3, red_torch=5, red_torch_sm=3 },
...
--  void = "STONE3",
    ...
    scenery = { blue_torch=5, blue_torch_sm=3, green_torch=5, green_torch_sm=3, red_torch=5, red_torch_sm=3, dead_player=3, gibbed_player=2, gibs=1 },
  ...
  URBAN_BROWN =
  {
    ...
    wall  = "BROWN1",
    floor = "FLOOR7_1",  -- "RROCK16" (not in doom 1)
    ceil  = "FLAT5_5",
...
--  void = "BROWNPIP",
  ...
  --  lift_floor = "FLOOR4_8",
    ...
    scenery = { red_torch=5, green_torch=5, blue_torch=5, dead_player=3, gibbed_player=2, skull_pole=3, skull_kebab=3, impaled_human=2 },
    good_liquid = "water",
...
--  void = "CEMENT3",
    step = "STEP4",
    pillar = "CEMENT3", -- "WOODMET4" not in doom 1
    pic_wd = "MARBFAC3",

    scenery = { lamp=5, impaled_twitch=2, impaled_human=4, hang_twitching=3, dead_player=2, gibbed_player=2 },
  },
...
--  void = "CEMENT3",
    step = "STEP6",
    pillar = "BROWNGRN", -- "WOODMET4" not in doom 1
    pic_wd = "MARBFACE",
...
--  void = "CEMENT3",
    step = "STEP6",
    pillar = "PIPE2", -- "WOODMET4" not in doom 1
    pic_wd = "MARBFAC2",
...
--  void = "CEMENT3",
    step = "STEP4",
    pillar = "BROWN1", -- "WOODMET4" not in doom 1
    pic_wd = "SHAWN1",

    scenery = { tech_column=5, lamp=5, impaled_twitch=2, impaled_human=2, hang_twitching=2, dead_player=2, gibbed_player=2 },
  },
  ...
  INDY_CEMENT =
  {
    ...
    wall  = "CEMENT6",
    floor = "FLOOR0_3",
    ceil  = "FLAT19",  -- "SLIME14" not in doom 1
...
--  lift_floor = "FLOOR4_8",
    ...
    scenery = { green_pillar=5, green_column=5, red_torch=5 },
...
DMC_HALLWAYS =
{
  ...
  BROWN2 =
  {
    ...
    theme_probs = { INDUSTRIAL=50,URBAN=20,TECH=40 },
    trim_mode = "guillotine",
  },
  ...
  GRAY =
  {
    ...
    theme_probs = { INDUSTRIAL=60,TECH=20 },
    trim_mode = "guillotine",
  },
  ...
  STONEDM1 =
  {
    ...
    theme_probs = { INDUSTRIAL=55,TECH=30 },
    trim_mode = "guillotine",
  },
...
DMC_LIQUIDS =
{
  ...
  blood = { floor="BLOOD1",  wall="ROCKRED1",   sec_kind=7 }, --  5% damage
  nukage= { floor="NUKAGE1", wall="ROCKRED1",   sec_kind=5 }, -- 10% damage
...
sw_blue =
  {
    ...
    door =
    {
      ...
      {
        key_w="COMPBLUE",
        door_w="BIGDOOR2", door_c="FLAT20",
        step_w="STEP4",  track_w="DOORTRAK",
        frame_f="FLAT5_4", frame_c="FLAT5_4",
        door_h=112,
        door_kind=0,
      }
    },
...
secret_enclosure_17_crate_wide =
  ...
  pillar_light1_TEK =
  {
    ...
    skin = { beam_w="SHAWN2", beam_f="FLAT20",
             lite_w="LITE5" },

    theme_probs = { TECH=8, INDUSTRIAL=16 },
  },
...
outdoor_mega_OPEN =
  ...
  fountain_STONE2 =
  {
    ...
    skin =
    {
      edge_w="MARBLE1", edge_f="FLOOR7_2",
      beam_w="MARBLE1", beam_f="FLOOR7_2",
      liquid_f="BLOOD1", liquid_w="BLODRIP1",
    },

    theme_probs = { URBAN=5, NATURE=10, HELL=90 },
  },
  ...
  fountain_STONE3 =
  {
    ...
    skin =
    {
      edge_w="MARBLE1", edge_f="FLOOR7_2",
      beam_w="MARBLE1", beam_f="FLOOR7_2",
      liquid_f="LAVA1", liquid_w="ROCKRED1",
    },

    theme_probs = { URBAN=3, NATURE=3, HELL=40 },
  },
...
wall_pic_SPDUDE2_enclosure =
  ...
  wall_pic_MARBFACE =
  {
    ...
    theme_probs = { HELL=90, CAVE=15, URBAN=5 },
  },
  ...
  wall_pic_MARBFAC2 =
  {
    ...
    theme_probs = { HELL=60, CAVE=10, URBAN=5 },
  },
  ...
  wall_pic_MARBFAC3 =
  {
    ...
    theme_probs = { HELL=50, CAVE=10, URBAN=5 },
  },
  ...
  wall_pic_TEKWALL4 =
  {
    ...
    min_height = 144,
    skin = { pic_w="TEKWALL4", lite_w="LITE5", pic_h=128 },
    theme_probs = { TECH=10 },
  },
  ...
  wall_cross_RED3 =
  {
    ...
    skin =
    {
      cross_w="FIREBLU2", back_w="FIREBLU2",
      cross_f="FLAT5_3",
      cross_lt=255, kind=0,
    },
  },
...
DMC_DOOR_PREFABS =
{
  ...
  silver_lit =
  {
    ...
    skin =
    {
      door_w="BIGDOOR2", door_c="FLAT20",
      lite_w="LITE5", step_w="STEP4",
      frame_f="FLAT5_4", frame_c="TLITE6_6",
      track_w="DOORTRAK",
      door_h=112,
      door_kind=1, tag=0,
    },
  ...
  uac_lit =  -- actual height is 96
  {
    ...
    theme_probs = { INDUSTRIAL=30,TECH=70 },
  },
  ...
  wooden =
  {
    ...
    theme_probs = { URBAN=20,CAVE=30,HELL=80,NATURE=1 }
  },
  ...
  wood_skull =
  {
    ...
    theme_probs = { HELL=90,CAVE=5,NATURE=1 },
  },
...
DMC_MISC_PREFABS =
{
  ...
  {
    prefab = "PEDESTAL",
    skin = { wall="METAL", floor="GATE4", ped_h=8 },
  },
...
-- TECH arch --
  ...
  {
    prefab = "ARCH_RUSSIAN",
    skin = { beam_w="SHAWN2", beam_c="FLAT23" },
  },
...
-- HELL arch --
  ...
  {
    prefab = "ARCH_RUSSIAN",
    skin = { beam_w="METAL", beam_c="CEIL5_2" },
  },
...
-- This is the Oblige Level Maker wall watermark
...
--[[  
   ...
   (h) hell    (indoor, fire/lava, bodies, blood)
--]]
  ...
  URBAN =
  {
    room_probs=
    {
      PLAIN=15, WAREHOUSE2=15, WAREHOUSE=15, PRISON=3,
    },
  ...
  INDUSTRIAL =
  {
    room_probs=
    {
      PLAIN=25, PLANT=90, WAREHOUSE=50, COMPUTER=10,
    },
  ...
  TECH =
  {
    room_probs=
    {
      PLAIN=15, COMPUTER=25, WAREHOUSE=10,
    },
  ...
  NATURE =
  {
    ...
    monster_prefs =
    {
      ...
      barrel=0.5, mancubus=1.5, arach=0.8
    },
    ...
    trim_mode = "rough_hew",
    has_outdoors = true,
    no_indoors = true, --- The only theme w/o indoors, as it turns out
  },

  --  CAVE really should be merged with outdoors
  CAVE =
  {
    room_probs=
    {
      PLAIN=20, WAREHOUSE2=10, TORTURE=20, PRISON=20
    },
  ...
  HELL =
  {
    ...
    monster_prefs =
    {
      zombie=0.5, shooter=0.7, gunner=0.5,
...
D2_MONSTERS =
{
  ...
  revenant  = { prob=70, hp=300, dm=55, fp=2.9, cage_prob=50, wuss=-70 },
  ...
  vile      = { prob=20, hp=700, dm=50, fp=3.7, cage_prob=12, 
...
DMC_MONSTER_WEAPON_PREFS =
{
  zombie  = { chain=2.0, shotty=6.0 },
  shooter = { chain=2.0, shotty=6.0 },
  imp     = { chain=2.0, shotty=6.0 },
  demon   = { super=3.0, launch=0.3 },
  spectre = { super=3.0, launch=0.3 },
  caco   = { super=2.0, launch=0.5 },
  gunner  = { shotty=6.0, super=4.0 },
  revenant= { super=4.0, plasma=2.0, launch=1.5 },

  pain    = { launch=0.1 },
  skull   = { launch=0.1 },

  baron     = { launch=1.25 },
  knight     = { super=2.0, launch=1.25 },
  arach   = { super=2.0, launch=2.0, plasma=1.5 },
  vile    = { super=2.0, plasma=2.0, launch=1.5 },
  mancubus = { super=3.0, lauch=1.33 },
...
DMC_PICKUPS =
{
  ...
  helmet   = { stat="health", give=1,  prob=10 },
...
DMC_NICENESS =
{
  ...
  p1 = { pickup="green_armor", prob=7.5 },
}
...
D1C_CRATES =
{
  ...
  SKIN =
  {
    wall = "SKINBORD", h=64, floor = "CRATOP2", can_rotate=true
  },
}
...
D1C_WALL_PREFABS =
{
  wall_pic_COMP2 =
  {
    ...
    skin = { pic_w="COMP2", lite_w="LITE3", pic_h=128 },
  },
-- lite_w was SUPPORT2
   ...
   wall_pic_COMPUTE1 =
  {
    ...
    min_height = 160,
    theme_probs = { TECH=90, INDUSTRIAL=30 },
    skin = { pic_w="COMPUTE1", lite_w="LITE3", pic_h=128 },
  },
   ...
   wall_pic_TEKWALL2 =
  {
    prefab = "WALL_PIC_SHALLOW",
    min_height = 144,
    skin = { pic_w="TEKWALL2", lite_w="LITE5", pic_h=128 },
    theme_probs = { TECH=10 },
  },
   ...
   wall_pic_TEKWALL3 =
  {
    prefab = "WALL_PIC_SHALLOW",
    min_height = 144,
    skin = { pic_w="TEKWALL3", lite_w="LITE5", pic_h=112 },
    theme_probs = { TECH=10 },
  },
-- Texture is actually 112 units tall -- Mr. Chris

   wall_pic_TEKWALL5 =
  {
    prefab = "WALL_PIC_SHALLOW",
    min_height = 144,
    skin = { pic_w="TEKWALL5", lite_w="LITE5", pic_h=128 },
    theme_probs = { TECH=10 },
  },
...
wall_pic_PLANET1 =
  {
    ...
    skin = { pic_w="PLANET1", lite_w="LITE3", pic_h=128, wall_lt=255, },
  },
...
-- Start light prefab thingies for Doom1 below
  ...
  lights_thin_LITERED2 =
  {
    prefab = "WALL_LIGHTS_THIN",
    min_height = 64,
    theme_probs = { TECH=40, HELL=1 },
    skin =
    {
      lite_w="LITERED", lite_side="LITERED",
      frame_f="FLOOR1_6",
  ...
  lights_thin_LITERED3 =
  {
    prefab = "WALL_LIGHTS_THIN",
    min_height = 128,
    theme_probs = { TECH=50, HELL=2 },
    skin =
    {
      lite_w="LITERED", lite_side="LITERED",
      frame_f="FLOOR1_6",
  ...
  wall_cross_RED2 =
  {
    ...
    skin =
    {
      cross_w="REDWALL1", back_w="REDWALL1",
      cross_f="FLOOR1_6",
      cross_lt=255, kind=0,
    },
  },

 lights_wide_LITEBLU3 =
  {
    prefab = "WALL_LIGHTS_WIDE",
    min_height = 128,
    theme_probs = { INDUSTRIAL=40 },
    skin =
    {
      lite_w="LITEBLU3", lite_side="LITEBLU3",
      frame_f="FLAT22",
      wall_lt=255, kind=8,
    },
  },

  lights_wide_LITEBLU3A =
  {
    prefab = "WALL_LIGHTS_WIDE",
    min_height = 128,
    theme_probs = { INDUSTRIAL=40 },
...
D1C_EPISODE_THEMES =
{
  { URBAN=3, INDUSTRIAL=5, TECH=9, CAVE=0, HELL=0 },
  { URBAN=4, INDUSTRIAL=7, TECH=4, CAVE=0, HELL=1 },
  { URBAN=3, INDUSTRIAL=3, TECH=2, CAVE=2, HELL=9 },
  { URBAN=4, INDUSTRIAL=4, TECH=3, CAVE=3, HELL=8 },

  -- this entry used for a single episode or level
  { URBAN=5, INDUSTRIAL=5, TECH=6, CAVE=1, HELL=5 },
}
...
function doom1c_get_levels(episode)

  local level_list = {}

  local theme_probs = D1C_EPISODE_THEMES[episode]
  if SETTINGS.length ~= "full" then
    theme_probs = D1C_EPISODE_THEMES[5]
  end
  ...
  for map = 1,9 do
    ...
    if D1C_SECRET_EXITS[Level.name] then
...
function doomc_common_factory()
  ...
  return
  {
    ...
    monsters = DMC_MONSTERS,
    bosses   = DMC_BOSSES,
    weapons  = DMC_WEAPONS,

    things = DM_THINGS,

    mon_give       = DMC_MONSTER_GIVE,
    mon_weap_prefs = DMC_MONSTER_WEAPON_PREFS,
    initial_model  = DMC_INITIAL_MODEL,

    pickups = DMC_PICKUPS,
    pickup_stats = { "health", "bullet", "shell", "rocket", "cell" },
    niceness = DMC_NICENESS,

    dm = DMC_DEATHMATCH,
    dm_exits = DMC_DEATHMATCH_EXITS,

    combos    = DMC_COMBOS,
    exits     = DMC_EXITS,
    hallways  = DMC_HALLWAYS,

    hangs     = DMC_OVERHANGS,
    pedestals = DMC_PEDESTALS,
    mats      = DMC_MATS,
    crates    = DMC_CRATES,

    liquids   = DMC_LIQUIDS,
    switches  = DMC_SWITCHES,
    doors     = DMC_DOORS,
    key_doors = DMC_KEY_DOORS,
    lifts     = DMC_LIFTS,
    ...
    sc_fabs   = DMC_SCENERY_PREFABS,
    feat_fabs = DMC_FEATURE_PREFABS,
    wall_fabs = DMC_WALL_PREFABS,

    door_fabs = DMC_DOOR_PREFABS,
    arch_fabs = DMC_ARCH_PREFABS,
    win_fabs  = DMC_WINDOW_PREFABS,
    misc_fabs = DMC_MISC_PREFABS,
...
GAME_FACTORIES["doom1c"] = function()

  local T = doomc_common_factory()

  con.printf("DEBUG MC: %s\n",table_to_str(T)) -- DEBUG
  T.episodes   = 4
  T.level_func = doom1c_get_levels

  T.quests   = D1C_QUESTS

  T.rooms    = copy_and_merge(T.rooms,    D1C_ROOMS)
  T.combos   = copy_and_merge(T.combos,   D1C_COMBOS)
  T.exits    = copy_and_merge(T.exits,    D1C_EXITS)
  T.hallways = copy_and_merge(T.hallways, D1C_HALLWAYS)
  T.crates   = copy_and_merge(T.crates,   D1C_CRATES)

  T.sc_fabs   = copy_and_merge(T.sc_fabs,   D1C_SCENERY_PREFABS)
  T.wall_fabs = copy_and_merge(T.wall_fabs, D1C_WALL_PREFABS)
